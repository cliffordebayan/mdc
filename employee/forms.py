...
class EmployeeForm(ModelForm):
    ...
    def get_next_employee_no(self):
        ...
        """
        from employee.methods.methods import get_next_employee_no

        return get_next_employee_no()
...
excel_columns = [
    ...
    ("employee_extension", trans("Extension")),
    ("gender", trans("Gender")),
    ...
    # Government IDs
    ("tin_number", trans("TIN Number")),
    ("sss_number", trans("SSS Number")),
    ("hdmf_number", trans("HDMF Number")),
    ("philhealth_number", trans("PhilHealth Number")),
    # Work Info
    ("employee_work_info__company_id", trans("Company")),
    ("employee_work_info__branch_id", trans("Branch")),
    ...
    ("employee_work_info__shift_id", trans("Shift Information")),
    ("employee_work_info__reporting_manager_id", trans("Reporting Manager")),
    ("employee_work_info__date_joining", trans("Joining Date")),
    ("employee_work_info__contract_end_date", trans("End Date")),
    ("years_of_service", trans("Years of Service")),
    ("is_active", trans("Is Active")),
    # Financial
    ("employee_work_info__basic_salary", trans("Salary")),
    ...
    # Tags / Insurance
    ("employee_work_info__tags", trans("Tags")),
...
class EmployeeExportExcelForm(forms.Form):
    selected_fields = forms.MultipleChoiceField(
        ...
        initial=[value for value, _ in excel_columns],
    )
