...
urlpatterns = [
    ...
    path("settings/branch-create/", views.branch_create, name="branch-create"),
    path("settings/branch-view/", views.branch_view, name="branch-view"),
    path(
        "settings/branch-update/<int:id>/",
        views.branch_update,
        name="branch-update",
        kwargs={"model": Branch},
    ),
    path(
        "settings/branch-delete/<int:obj_id>/",
        views.object_delete,
        name="branch-delete",
        kwargs={"model": Branch, "redirect": "/settings/branch-view"},
    ),
    path("settings/cost-center-create/", views.cost_center_create, name="cost-center-create"),
    path("settings/cost-center-view/", views.cost_center_view, name="cost-center-view"),
    path(
        "settings/cost-center-update/<int:id>/",
        views.cost_center_update,
        name="cost-center-update",
        kwargs={"model": CostCenter},
    ),
    path(
        "settings/cost-center-delete/<int:obj_id>/",
        views.object_delete,
        name="cost-center-delete",
        kwargs={"model": CostCenter, "redirect": "/settings/cost-center-view"},
    ),
    path("settings/business-unit-create/", views.business_unit_create, name="business-unit-create"),
    path("settings/business-unit-view/", views.business_unit_view, name="business-unit-view"),
    path(
        "settings/business-unit-update/<int:id>/",
        views.business_unit_update,
        name="business-unit-update",
        kwargs={"model": BusinessUnit},
    ),
    path(
        "settings/business-unit-delete/<int:obj_id>/",
        views.object_delete,
        name="business-unit-delete",
        kwargs={"model": BusinessUnit, "redirect": "/settings/business-unit-view"},
    ),
