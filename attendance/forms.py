...
class AttendanceExportForm(forms.Form):
    ...
    field_choices = [
        ...
        ("check_in_location", _("Check-In Location")),
        ("check_in_maps", _("Check-In Map")),
        ("check_out_location", _("Check-Out Location")),
        ("check_out_maps", _("Check-Out Map")),
        ("shift_id", _("Shift")),
...
class AttendanceActivityExportForm(forms.Form):
    ...
    field_choices = [
        ...
        ("daily_break_in", _("Break In")),
        ("daily_break_out", _("Break Out")),
        ("daily_lunch_in", _("Lunch In")),
        ("daily_lunch_out", _("Lunch Out")),
        ("daily_clock_in_location", _("Clock In Location")),
        ("daily_clock_out_location", _("Clock Out Location")),
        ("daily_break_in_location", _("Break In Location")),
        ("daily_break_out_location", _("Break Out Location")),
        ("daily_lunch_in_location", _("Lunch In Location")),
        ("daily_lunch_out_location", _("Lunch Out Location")),
        ("daily_clock_image", _("Clock Image")),
        ("daily_break_image", _("Break Image")),
        ("daily_lunch_image", _("Lunch Image")),
        ("daily_shift", _("Shift")),
